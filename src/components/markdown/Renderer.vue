...
.size-small {
  .markdown-content {
    ...
    h1 { font-size: var(--chat-font-size-bot-headers, 16px); }
    h2 { font-size: calc(var(--chat-font-size-bot-headers, 16px) * 0.9); }
    h3 { font-size: calc(var(--chat-font-size-bot-headers, 16px) * 0.8); }

    p, ul, ol, code { font-size: var(--chat-font-size-bot, 13px); }
